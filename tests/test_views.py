...
class SingleTableViewTest(TestCase):
    ...
    def test_get_tables_class_raises_no_model(self):
        ...
        message = "You must either specify SimpleNoTableClassNoModelView.table_class or SimpleNoTableClassNoModelView.model"
...
class MultiTableMixinTest(TestCase):
    ...
    def test_without_tables(self):
        ...
        with self.assertRaisesMessage(
            ImproperlyConfigured, "No tables were specified. Define View.tables"
        ):
            View.as_view()(build_request("/"))
    ...
    def test_length_mismatch(self):
        ...
        with self.assertRaisesMessage(
            ImproperlyConfigured, "len(View.tables_data) != len(View.tables)"
        ):
            View.as_view()(build_request("/"))
