...
class DeclarativeColumnsMetaclass(type):
    ...
    def __new__(mcs, name, bases, attrs):
        ...
        attrs["base_columns"] = collections.OrderedDict(parent_columns)
        ...
        attrs["base_columns"].update(collections.OrderedDict(cols))
        ...
        if opts.sequence:
            ...
            attrs["base_columns"] = collections.OrderedDict(((x, attrs["base_columns"][x]) for x in opts.sequence))
